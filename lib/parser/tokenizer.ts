...
class Tokenizer {
  readonly operators = [
    ...
    ['downto', 'to', 'others', 'when', 'else', 'range', 'elsif', 'after', 'transport', 'reject', 'intertial'],
    ['of']
  ];
  tokenTypes = [
    ...
    { regex: /^x"[0-9A-F_ZWLH-UX]+"/i, tokenType: 'LOGIC_LITERAL' },
    { regex: /^b"[01ZWLH-UX]+"/i, tokenType: 'LOGIC_LITERAL' },
    { regex: /^'[0-9ZWLH-UX]+'/i, tokenType: 'LOGIC_LITERAL' },
